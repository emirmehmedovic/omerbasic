...
import { generatePackingSlipPDF } from '@/lib/pdf-generators';
...
export async function GET(
  ...
  try {
    ...
    console.error('[PACKING_SLIP_GET] Error stack:', error instanceof Error ? error.stack : 'N/A');
    console.error('[PACKING_SLIP_GET] Error message:', error instanceof Error ? error.message : String(error));
