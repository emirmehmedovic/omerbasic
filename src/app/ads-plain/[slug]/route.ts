...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .wrap{box-sizing:border-box;padding:24px;width:100%;height:100%;display:flex;flex-direction:column;gap:24px;}
      ...
      .logo{max-width:85%;max-height:85%;filter:drop-shadow(0 8px 24px rgba(0,0,0,0.5));}
      ...
      .hero{display:grid;grid-template-columns:1fr 2fr 2fr;gap:20px;height:100%;margin:0;}
      ...
      <div class="wrap">
        <div class="content">
          ...
          <div class="hero-overlay">
            <div class="hero">
              <div class="card glass"><div class="card-inner"><img src="/images/omerbasic.png" alt="Logo" class="logo"/></div></div>
              <div class="card accent"><div class="card-inner"><div class="card-title"><span class="title-chip">Od Jelaha do cijele BiH,<br> pouzdani dijelovi za svaki teren</span></div></div></div>
              <div class="card blue"><div class="card-inner"><div class="card-title"><span class="title-chip">Brzo, jednostavno, dostupno, potraži odmah!</span></div></div></div>
            </div>
          </div>
        </div>
      </div>
